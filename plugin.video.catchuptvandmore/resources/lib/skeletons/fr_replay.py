...
menu = {
    'tf1': {
        'route': '/resources/lib/channels/fr/mytf1:list_categories',
        'label': 'TF1',
    ...
    'canalplus': {
        'route': '/resources/lib/channels/fr/mycanal:list_categories',
        'label': 'Canal +',
    ...
    'm6': {
        'route': '/resources/lib/channels/fr/6play:list_categories',
        'label': 'M6',
    ...
    'nrj12': {
        'route': '/resources/lib/channels/fr/nrj:list_categories',
        'label': 'NRJ 12',
